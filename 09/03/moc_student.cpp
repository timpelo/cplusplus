...
QT_MOC_LITERAL(1, 8, 20), // "complainToHannuKarpo"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "Student\0complainToHannuKarpo\0"
};
...
void Student::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->complainToHannuKarpo(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Student::staticMetaObject = {
    { &Person::staticMetaObject, qt_meta_stringdata_Student.data,

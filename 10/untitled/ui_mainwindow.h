...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(704, 382);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        horizontalLayoutWidget = new QWidget(centralWidget);
        horizontalLayoutWidget->setObjectName(QStringLiteral("horizontalLayoutWidget"));
        horizontalLayoutWidget->setGeometry(QRect(0, 0, 701, 321));
        ...
        QBrush brush2(QColor(171, 171, 171, 255));
        brush2.setStyle(Qt::SolidPattern);
        palette.setBrush(QPalette::Active, QPalette::Light, brush2);
        QBrush brush3(QColor(142, 142, 142, 255));
        ...
        playNowButton = new QPushButton(horizontalLayoutWidget);
        playNowButton->setObjectName(QStringLiteral("playNowButton"));

        verticalLayout->addWidget(playNowButton);

        playRandomButton = new QPushButton(horizontalLayoutWidget);
        playRandomButton->setObjectName(QStringLiteral("playRandomButton"));

        verticalLayout->addWidget(playRandomButton);
        ...
        QObject::connect(dial, SIGNAL(sliderMoved(int)), timer, SLOT(display(int)));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        playNowButton->setText(QApplication::translate("MainWindow", "PLAY NOW", 0));
        playRandomButton->setText(QApplication::translate("MainWindow", "PLAY RANDOM", 0));
    } // retranslateUi
